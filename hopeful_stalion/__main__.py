...
class SelectGameDataScene(scene_trans.Scene):
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.menu_ui = ui.UIGameMenu(
            pos=[SCRN_WIDTH / 2.75, SCRN_HEIGHT / 3.5])
        # self.sm.game.databank
        # self.menu_ui.add_widget(ui.TextWidget(
...
class TitleScene(scene_trans.Scene):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.menu_ui = ui.UIGameMenu(pos=[SCRN_WIDTH / 3, SCRN_HEIGHT / 2.9])
        self.menu_ui.spacing = 16
        self.menu_ui.add_widget(
            ui.TextWidget(self.font_titlemenu,
